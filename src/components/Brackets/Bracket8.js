...
export default function Bracket8({ teams, matches, onChangeMatches, isHybrid, thirdPlaceMatch }) {
  ...
  useEffect(() => {
    ...
    const matchesToSave = [
      { id: "QF1", round: "QF1", phase: "knockout", home: matchData.QF1.home, away: matchData.QF1.away, date: matchData.QF1.date, time: matchData.QF1.time, nextPosition: "home", status: "Načrtovana" },
      { id: "QF2", round: "QF2", phase: "knockout", home: matchData.QF2.home, away: matchData.QF2.away, date: matchData.QF2.date, time: matchData.QF2.time, nextPosition: "away", status: "Načrtovana" },
      { id: "QF3", round: "QF3", phase: "knockout", home: matchData.QF3.home, away: matchData.QF3.away, date: matchData.QF3.date, time: matchData.QF3.time, nextPosition: "home", status: "Načrtovana" },
      { id: "QF4", round: "QF4", phase: "knockout", home: matchData.QF4.home, away: matchData.QF4.away, date: matchData.QF4.date, time: matchData.QF4.time, nextPosition: "away", status: "Načrtovana" },
